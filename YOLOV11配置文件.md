...
401. ultralytics/cfg/models/11/yolo11-ESMoE.yaml

    使用[YOLO-Master](https://github.com/isLinXu/YOLO-Master)中的ES-MoE模块改进Yolo11.
    项目视频百度云链接:20260114版本更新说明

402. ultralytics/cfg/models/11/yolo11-C2PSA-SWSA.yaml

    使用[ACMMM2025 FlickCD](https://dl.acm.org/doi/epdf/10.1145/3746027.3755657)中的SWSA改进C2PSA.(需要看[常见错误和解决方案的第五点](#a))
    项目视频百度云链接:20260114版本更新说明

403. ultralytics/cfg/models/11/yolo11-C2PSA-EGSA.yaml

    使用[ACMMM2025 FlickCD](https://dl.acm.org/doi/epdf/10.1145/3746027.3755657)中的EGSA改进C2PSA.(需要看[常见错误和解决方案的第五点](#a))
    项目视频百度云链接:20260114版本更新说明
