...
def parse_model(d, ch, verbose=True, warehouse_manager=None):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in ((
            ...
            RepStem, ESMoE, SPDSlice, LSPDSlice, FED, LFED, EnhanceLocalSPPF, RES_EnhanceLocalSPPF, CAF_EnhanceLocalSPPF, CAF_RES_EnhanceLocalSPPF, FAFF, LFAFF, FSCF, CGFF, ASCSPP,
