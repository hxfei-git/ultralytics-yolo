...
C3K2_CLASS = (C3k2_Faster, C3k2_ODConv, C3k2_Faster_EMA, C3k2_DBB, C3k2_DeepDBB, C3k2_WDBB, C3k2_CloAtt, C3k2_SCConv, C3k2_ScConv, C3k2_EMSC, C3k2_EMSCP, C3k2_KW, C3k2_DySnakeConv, C3k2_DCNv2, C3k2_DCNv3,
              ...
              C3k2_ConverseB, C3k2_Converse, C3k2_GCConv, C3k2_CFBlock, C3k2_FMABlock, C3k2_LWGA, C3k2_CSSC, C3k2_CNCM, C3k2_HFRB, C3k2_EVA, C3k2_RMBC, C3k2_RMBC_LA, C3k2_IEL, C3k2_SFMB, C3k2_CGFF_10, C3k2_CGFF_25, C3k2_CGFF_50, C3k2_CGFF_75, C3k2_CGFF_90,
              )
...
def parse_model(d, ch, verbose=True, warehouse_manager=None):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in ((
            ...
            RepStem, ESMoE, SPDSlice, LSPDSlice, FED, LFED, EnhanceLocalSPPF, RES_EnhanceLocalSPPF, CAF_EnhanceLocalSPPF, CAF_RES_EnhanceLocalSPPF, FAFF, LFAFF, FSCF, ASCSPP, ACSPP, ACSPP_1, DSSPP,
            ...
            if m in ((
                ...
                MANet_FasterBlock, MANet_FasterCGLU, MANet_Star, CSP_MSCB_SC, MANet_GCConv, SPDSlice, LSPDSlice, FED, LFED,
            ) + C3K2_CLASS + A2C2F_CLASS + C2PSA_CLASS):
        ...
        #     args = [c2, *args]
            ...
            c2 = c1[0]
            args = [c1]
        elif m in {HAFB, MFM, CGF_1, CGF_2, CGF_3}:
            if args[0] == 'head_channel':
                args[0] = d[args[0]]
            c1 = [ch[x] for x in f]
            c2 = make_divisible(min(args[0], max_channels) * width, 8)
            ...
            c2, up_f = ch[f], args[0]
            args = [up_f]
        elif m in {Pzconv, FCM, FCM_1, FCM_2, FCM_3, CGFF_25}:
            c2 = ch[f]
            args = [c2]
